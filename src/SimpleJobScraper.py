...
class SimpleJobScraper:
    ...
    def scrape_jobs(self):
        for jobs in self.jobPortal_configs:
            ...
            self.get_web_content(url, request_method=request_method)

    
    def get_web_content(self, url, request_method='GET', headers=None, params=None):
...
if __name__ == "__main__":
    ...
    print(f"Found jobs: {scraper.jobs_html}")